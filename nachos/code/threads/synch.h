...
private:
    ...
    int held;                      // determin lock locked or not
    List* queue;                        //threads waiting for lock
    Thread* holder; 
    int initialPriority;                    //holder holding the lock
...
//------------------------------------------------------
//LBS Mailbox for cse120 project1 problem2
//
//
//------------------------------------------------------
...
private:
     ...
     int Receive_Counter;
     int Mail_Counter;
     Condition* Receive_Condition;
     Condition* Send_Condition;
     Condition* Mail_Condition;
     int* buffer;
};
class Whale{
public:
...
private:
     ...
     int Matchmakernum;
     Semaphore* Male_Sema;
     Semaphore* Female_Sema;
     Semaphore* Matchmaker_Sema;
     char* Malename;
     char* Femalename;
     Semaphore* Maleend_Sema;
     Semaphore* Femaleend_Sema;
     Semaphore* Matchmakerend_Sema;
